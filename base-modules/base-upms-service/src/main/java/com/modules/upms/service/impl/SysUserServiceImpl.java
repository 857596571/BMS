...
import com.modules.upms.service.SysDeptRelationService;
import com.modules.upms.service.SysMenuService;
import com.modules.upms.service.SysUserRoleService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    @Override
    public Page selectWithRolePage(Page query, UserVO userVO) {
        DataScope dataScope = new DataScope();
        dataScope.setScopeName("deptId");
        dataScope.setIsOnly(true);
        dataScope.setDeptIds(getChildDepts(userVO));
        Object username = query.condition().get("username");
