...
import com.modules.upms.model.entity.SysDict;
...
public class DictController extends BaseController {
     ...
     */
    @GetMapping("/dictPage")
    public Page dictPage(Page page, Map<String, Object> params) {
        params.put(CommonConstant.DEL_FLAG, CommonConstant.STATUS_NORMAL);
        return (Page) sysDictService.page(page, new QueryWrapper<>());
    }
    ...
    public R<Boolean> dict(@RequestBody SysDict sysDict) {
        return new R<Boolean>(sysDictService.save(sysDict));
    }
