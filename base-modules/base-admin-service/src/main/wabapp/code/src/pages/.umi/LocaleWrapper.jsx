...
const localeInfo = {
  'en-US': {
    messages: require('/Users/xiongmenghui/workspace/项目资料/base/base-system-web/src/main/wabapp/code/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('/Users/xiongmenghui/workspace/项目资料/base/base-system-web/src/main/wabapp/code/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('/Users/xiongmenghui/workspace/项目资料/base/base-system-web/src/main/wabapp/code/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('/Users/xiongmenghui/workspace/项目资料/base/base-system-web/src/main/wabapp/code/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
